...
namespace DSS.Procedural
{
    public class Bezier : ISpline
    {
        ...
        public static Bezier ConstructSmoothSpline(bool closed, params Vector3[] points)
        {
            return ConstructSmoothSpline(points);
        }
        
        public static Bezier ConstructSmoothSpline(IList<Vector3> points, bool closed = false)
        {
