...
public class SteamVR_Camera : MonoBehaviour
{
	...
	public bool positionGameWindow = true;
	public bool disableTracking = false;
	public bool wireframe = false;

	static bool calibrating = true, trackingOutOfRange; // status
	...
	void OnPostRender()
	{
		...
		GL.TexCoord2(0.0f, v0); GL.Vertex3(0, 1, 0);
		GL.TexCoord2(1.0f, v0); GL.Vertex3(1, 1, 0);
		GL.TexCoord2(1.0f, v1); GL.Vertex3(1, 0, 0);
		GL.TexCoord2(0.0f, v1); GL.Vertex3(0, 0, 0);
		GL.End();
		GL.PopMatrix();
	}
}
